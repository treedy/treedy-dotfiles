...
if [[ $PRECHECK -eq 1 ]]; then
  echo "Prerequesite check failed. Install necessary software"
  exit 1
fi
...
echo "Make sure to exit once OMZ is installed to continue"
...
echo
echo -e "${GREEN} Script complete!${NOCOLOR}. Please restart your session."
